...
/**
 * Describes how a form can be used in the EMR. Each form should have a
 * component of this type in the application
 * context.
 */
public class GbvFormDescriptor extends AbstractEntityDescriptor<Form> implements AppRestrictedDescriptor {
	...
	/**
	 * @see org.openmrs.module.gbv.app.AppRestrictedDescriptor#getApps()
	 */
	@Override
	...
	/**
	 * @see org.openmrs.module.gbv.app.AppRestrictedDescriptor#setApps(java.util.Set)
	 */
	@Override
