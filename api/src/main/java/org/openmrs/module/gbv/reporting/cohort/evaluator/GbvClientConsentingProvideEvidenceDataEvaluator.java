...
@Handler(supports = { GbvClientConsentingProvideEvidenceDataDefinition.class })

public class GbvClientConsentingProvideEvidenceDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
            throws EvaluationException {
                ...
                String qry = "select encounter_id,provide_evidence from kenyaemr_etl.etl_gbv_consenting;";
