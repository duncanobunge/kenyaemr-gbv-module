...
@Handler(supports = { GbvClientConsentingWitnessNameDataDefinition.class })

public class GbvClientConsentingWitnessNameDataEvaluator implements EncounterDataEvaluator{
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
            throws EvaluationException {
                ...
                String qry = "select encounter_id,witness_name from kenyaemr_etl.etl_gbv_consenting;";
