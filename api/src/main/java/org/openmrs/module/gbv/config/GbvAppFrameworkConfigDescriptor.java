 ...
 *}
 */
public class GbvAppFrameworkConfigDescriptor {
    ...
    @JsonProperty
    private Map<String,GbvAppConfigDescriptor> appConfiguration;

    @JsonProperty
    private Map<String,GbvExtensionConfigDescriptor> extensionConfiguration;
    ...
    public Map<String, GbvAppConfigDescriptor> getAppConfiguration() {
        return appConfiguration;
    }

    public void setAppConfiguration(Map<String, GbvAppConfigDescriptor> appConfiguration) {
        this.appConfiguration = appConfiguration;
    }

    public Map<String, GbvExtensionConfigDescriptor> getExtensionConfiguration() {
        return extensionConfiguration;
    }

    public void setExtensionConfiguration(Map<String, GbvExtensionConfigDescriptor> extensionConfiguration) {
