...
public class FormUtils {
	...
	/**
	 * Gets the XML resource path of the given form (null if form doesn't have an
	 * XML resource)
	 * 
	 * @param form the form
	...
	public static HtmlForm getHtmlForm(Form form, ResourceFactory resourceFactory) throws IOException {
		...
		String xml = resourceFactory.getResourceAsString(xmlResource.getProvider(),
				"htmlforms/" + xmlResource.getPath());
