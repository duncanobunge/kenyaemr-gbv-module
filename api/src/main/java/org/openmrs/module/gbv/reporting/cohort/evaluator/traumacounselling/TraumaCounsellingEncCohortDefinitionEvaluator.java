...
@Handler(supports = { TraumaCounsellingEncCohortDefinition.class })
public class TraumaCounsellingEncCohortDefinitionEvaluator implements EncounterQueryEvaluator {
	...
	public EncounterQueryResult evaluate(EncounterQuery definition, EvaluationContext context) throws EvaluationException {
		...
		String qry ="select encounter_id from kenyaemr_etl.etl_gbv_counsellingencounter where date(visit_date) between date(:startDate) and date(:endDate);";
