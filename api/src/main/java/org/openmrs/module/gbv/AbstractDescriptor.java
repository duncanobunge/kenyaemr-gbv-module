...
/**
 * Abstract base class for all descriptors that are instantiated as beans and
 * can be identified via their component
 * name.
 */
public abstract class AbstractDescriptor implements BeanNameAware, Descriptor {
	...
	/**
	 * @see org.openmrs.module.gbv.Descriptor#getId()
	 */
	@Override
	public String getId() {
		return id;
