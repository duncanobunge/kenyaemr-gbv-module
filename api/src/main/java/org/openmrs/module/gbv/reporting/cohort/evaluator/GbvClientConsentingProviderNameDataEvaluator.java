...
@Handler(supports = { GbvClientConsentingProviderNameDataDefinition.class })

public class GbvClientConsentingProviderNameDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
            throws EvaluationException {
                ...
                String qry = "select encounter_id,provider_name from kenyaemr_etl.etl_gbv_consenting;";
