...
/**
 * An action that can be chosen in response to an {@link GbvAdministrativeNotification}.
 *
 * Typically a module will implement an AdministrativeNotificationProducer, which will generate one or more
 * {@link GbvAdministrativeNotification}s, each with one or more AdministrativeNotificationActions.
 *
 ...
 */
public class GbvAdministrativeNotificationAction {
