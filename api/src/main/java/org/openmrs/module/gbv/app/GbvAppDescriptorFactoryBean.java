...
/**
 * There's no nice way to create components of the AppDescriptor class defined
 * in the App Framework module so we use
 * this factory bean.
 */
@Component("kenyagbv.appFactoryBean")
public class GbvAppDescriptorFactoryBean {
