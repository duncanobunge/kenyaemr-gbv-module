 ...
 */
public class GbvAdministrativeNotification {
    ...
    @JsonProperty
    private List<GbvAdministrativeNotificationAction> actions;
    ...
    public List<GbvAdministrativeNotificationAction> getActions() {
        return actions;
    }

    public void setActions(List<GbvAdministrativeNotificationAction> actions) {
