...
public class ReportConfiguration extends AbstractContentConfiguration {
	...
	private Map<GbvProgramDescriptor, Set<ReportDescriptor>> programReports;
	 ...
	 */
	public Map<GbvProgramDescriptor, Set<ReportDescriptor>> getProgramReports() {
	 ...
	 */
	public void setProgramReports(Map<GbvProgramDescriptor, Set<ReportDescriptor>> programReports) {
