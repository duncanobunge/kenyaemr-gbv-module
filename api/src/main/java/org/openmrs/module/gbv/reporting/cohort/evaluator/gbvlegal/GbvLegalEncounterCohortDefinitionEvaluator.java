...
@Handler(supports = { GbvLegalEncounterCohortDefinition.class })
public class GbvLegalEncounterCohortDefinitionEvaluator implements EncounterQueryEvaluator {
...
private final Log log = LogFactory.getLog(this.getClass());
	...
	public EncounterQueryResult evaluate(EncounterQuery definition, EvaluationContext context) throws EvaluationException {
		...
		String qry ="select encounter_id from kenyaemr_etl.etl_gbv_legal where date(visit_date) between date(:startDate) and date(:endDate);";
