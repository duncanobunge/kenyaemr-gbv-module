 ...
 */
@Component("gbvappFrameworkConfig")
public class GbvAppFrameworkConfig {
    ...
    private List<GbvAppFrameworkConfigDescriptor> descriptors;

    private PathMatchingResourcePatternResolver resourceResolver = new PathMatchingResourcePatternResolver();

    private ObjectMapper objectMapper = new ObjectMapper();

    public GbvAppFrameworkConfig() {
        descriptors = new ArrayList<GbvAppFrameworkConfigDescriptor>();
    ...
    public Boolean isEnabled(AppDescriptor app) {
        ...
        for (GbvAppFrameworkConfigDescriptor descriptor : descriptors) {
    ...
    public Boolean isEnabled(GbvExtension extension) {
    ...
    public void refreshContext() {
        ...
        if (profileStream != null) {
            try {
                addAppFrameworkConfigDescriptor(objectMapper.readValue(profileStream, GbvAppFrameworkConfigDescriptor.class));
            }
            catch (IOException e) {
     ...
     * @param descriptor
     */
    public void addAppFrameworkConfigDescriptor(GbvAppFrameworkConfigDescriptor descriptor) {
