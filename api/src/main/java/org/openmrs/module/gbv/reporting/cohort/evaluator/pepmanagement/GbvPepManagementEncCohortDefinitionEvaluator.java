...
@Handler(supports = { GbvPepManagementEncCohortDefinition.class })
public class GbvPepManagementEncCohortDefinitionEvaluator implements EncounterQueryEvaluator{
	...
	public EncounterQueryResult evaluate(EncounterQuery definition, EvaluationContext context) throws EvaluationException {
		...
		String qry ="select encounter_id from kenyaemr_etl.etl_gbv_pepmanagementforsurvivors where date(visit_date) between date(:startDate) and date(:endDate);";
