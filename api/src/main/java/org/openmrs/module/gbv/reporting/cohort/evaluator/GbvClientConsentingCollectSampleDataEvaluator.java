...
@Handler(supports = {GbvClientConsentingCollectSampleDataDefinition.class })

public class GbvClientConsentingCollectSampleDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
            throws EvaluationException {
                ...
                String qry = "select encounter_id,collect_sample from kenyaemr_etl.etl_gbv_consenting;";
