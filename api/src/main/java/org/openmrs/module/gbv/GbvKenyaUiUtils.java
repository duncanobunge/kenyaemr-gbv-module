 ...
 */
 ...
 import org.openmrs.module.gbv.wrapper.GbvKenyaEMRObsWrapper;
  ...
  */
 @Component
 public class GbvKenyaUiUtils {
 
     private static final DateFormat dateFormatter = new SimpleDateFormat(ExampleConstants.DATE_FORMAT);
 
     private static final DateFormat timeFormatter = new SimpleDateFormat(ExampleConstants.TIME_FORMAT);
     ...
     public AppDescriptor getCurrentApp(PageRequest request) {
         return (AppDescriptor) request.getRequest().getAttribute(ExampleConstants.REQUEST_ATTR_CURRENT_APP);
     }
     ...
     public AppDescriptor getCurrentApp(FragmentActionRequest request) {
         return (AppDescriptor) request.getHttpRequest().getAttribute(ExampleConstants.REQUEST_ATTR_CURRENT_APP);
     }
      ...
      * @return
      */
     public String formatObsWrapper(GbvKenyaEMRObsWrapper o) {
