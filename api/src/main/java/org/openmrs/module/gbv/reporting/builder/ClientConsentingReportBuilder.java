...
import org.openmrs.module.gbv.reporting.cohort.definition.GBVConsentingRegisterCohortDefinition;
...
@Component
@Builds({ "" })
public class ClientConsentingReportBuilder extends AbstractReportBuilder {
	...
	protected DataSetDefinition reportColumns() {
		...
		dsd.addColumn("Consenting date", new ClientConsentingDateDataDefinition(), null);
		
		// new columns
		GBVConsentingRegisterCohortDefinition cd = new GBVConsentingRegisterCohortDefinition();
