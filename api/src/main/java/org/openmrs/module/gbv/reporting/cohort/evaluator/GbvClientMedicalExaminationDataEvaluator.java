...
@Handler(supports = { GbvClientMedicalExaminationDataDefinition.class })
public class GbvClientMedicalExaminationDataEvaluator implements EncounterDataEvaluator{
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
            throws EvaluationException {
                ...
                String qry = "select encounter_id,medical_examination from kenyaemr_etl.etl_gbv_consenting;";
